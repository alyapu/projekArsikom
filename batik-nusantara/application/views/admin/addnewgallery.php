<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Add New Gallery</h1>
                    ...
                    <div class="card-body">
                        <?= form_open_multipart('Admin/addnewgallery'); ?>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="gname" name="gname" value="<?= set_value('gname'); ?>" required>
                                <?= form_error('gname', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="mb-3">
                                <label for="gdesc" class="form-label">Description</label>
                                <textarea class="form-control" id="gdesc" name="gdesc" rows="4" required><?= set_value('gdesc'); ?></textarea>
                                <?= form_error('gdesc', '<small class="text-danger">', '</small>'); ?>
                            </div>
                            <div class="mb-3">
                                <label for="gpict" class="form-label">Image</label>
                                <input type="file" class="form-control" id="gpict" name="gpict" accept=".png, .jpg, .jpeg, .gif" required>
